...
export function HatDetail({
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (hat.image_url) {
        const filename = hat.image_url.split("/").pop();
        if (filename) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>{hat.team}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="font-medium">{hat.team}</p>
            </div>
            ...
            <div>
              ...
              <p className="font-medium">
                {hat.color_design || "Not specified"}
              </p>
            </div>
            ...
            <div>
              ...
              <p className="font-medium">{formatDate(hat.created_at)}</p>
            </div>
          </div>
